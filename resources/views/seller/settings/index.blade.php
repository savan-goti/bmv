                        ...
                        <div class="mb-4">
                            ...
                            @if($seller->two_factor_enabled && $seller->two_factor_confirmed_at)
                                ...
                                <div class="alert alert-success">
                                    ...
                                    <br>
                                    <small class="text-muted">Enabled on {{ $seller->two_factor_confirmed_at->format('d M Y, h:i A') }}</small>
                                </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @if($seller->email_verified_at)
                                            <p class="text-success mb-0">
                                                ...
                                                Email verified on {{ $seller->email_verified_at->format('d M Y, h:i A') }}
                                            </p>
                                        @else
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">{{ $seller->last_login_ip ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted small">Account Status</label>
                                <p class="mb-0">
                                    <span class="badge bg-{{ $seller->status == 1 ? 'success' : 'danger' }}">
                ...
                <div class="card mt-4 border-danger">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="text-muted mb-3">
                            <li>Permanently delete your seller account</li>
...
<script>
    $(document).ready(function() {
        ...
        function loadSessions() {
            $.ajax({
                url: "{{ route('seller.settings.sessions') }}",
                method: "GET",
                dataType: "json",
                success: function (result) {
        ...
        $(document).on('click', '.logout-session-btn', function() {
            ...
            $.ajax({
                url: "{{ route('seller.settings.sessions.logout') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#logoutAllOthersBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('seller.settings.sessions.logout-others') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#enableTwoFactorBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('seller.settings.two-factor.enable') }}",
                method: "POST",
                dataType: "json",
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $('#verifyTwoFactorForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('seller.settings.two-factor.confirm') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#disableTwoFactorBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('seller.settings.two-factor.disable') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#regenerateRecoveryCodesBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('seller.settings.two-factor.recovery-codes') }}",
                method: "POST",
                dataType: "json",
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $('#deleteAccountBtn').on('click', function() {
            ...
            $('#confirmDeleteBtn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('seller.settings.delete-account') }}",
                    method: "POST",
                    dataType: "json",
                    data: formData,
                    processData: false,
