    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a @if(!in_array(request()->route()->getName(),['seller.dashboard'])) href="{{ route('seller.dashboard') }}" @endif class="nav-link menu-link @if(in_array(request()->route()->getName(),['seller.dashboard'])) active @endif">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link menu-link">
                        <i class="ri-shopping-bag-line"></i> <span data-key="t-products">Products</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="#" class="nav-link menu-link">
                        <i class="ri-file-list-line"></i> <span data-key="t-orders">Orders</span>
                    </a>
                </li>
