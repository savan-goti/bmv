...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>We received a request to reset your staff account password. If you made this request, click the button below to reset your password:</p>
            
            <div style="text-align: center;">
                <a href="{{ route('staff.reset-password.form', $token) }}" class="reset-button">
                    Reset Password
                </a>
            </div>
            ...
            <p style="word-break: break-all; color: #667eea; font-size: 13px;">
                {{ route('staff.reset-password.form', $token) }}
            </p>
