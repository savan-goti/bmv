...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('owner.collections.update', $collection->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                @if($collection->getRawOriginal('image'))
                                    <div class="mt-2">
                                        ...
                                        <img src="{{ asset('uploads/collections/' . $collection->getRawOriginal('image')) }}" 
                                            alt="{{ $collection->name }}" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                @endif
