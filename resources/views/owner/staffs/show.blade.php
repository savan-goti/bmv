            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('owner.staffs.index') }}">Staffs</a></li>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($staff->admin)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('owner.admins.show', $staff->admin->id) }}">
                                                            {{ $staff->admin->name }}
                                                        </a>
                                                    </td>
                                                </tr>
                            ...
                            <div class="mt-4">
                                <a href="{{ route('owner.staffs.edit', $staff->id) }}" class="btn btn-primary me-2">
                                    <i class="bx bx-edit"></i> Edit Staff
                                </a>
                                <a href="{{ route('owner.staffs.index') }}" class="btn btn-secondary">
