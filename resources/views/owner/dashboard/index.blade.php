                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Good Morning, {{Auth::guard('owner')->user()->name}}!</h4>
                                <p class="text-muted mb-0">
                                    Welcome to your owner dashboard. Manage your system efficiently.
                                </p>
                            </div>
                        </div>
                        <!-- end card header -->
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    ...
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-warning-subtle rounded fs-3">
                                            <i class="bx bxs-user-circle text-warning"></i>
                                        </span>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script !src="">
        $(document).ready(function (){
            sendToast("Welcome to Owner Dashboard!",'primary');
        });
    </script>
@endsection
