        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('owner.support-team.edit', $supportTeamMember->id) }}" class="btn btn-primary">Edit</a>
                    <a href="{{ route('owner.support-team.index') }}" class="btn btn-secondary">Back to List</a>
                </div>
            </div>
        </div>
    </div>
