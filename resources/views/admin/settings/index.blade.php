                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @if($admin->email_verified_at)
                                            <p class="text-success mb-0">
                                                ...
                                                Email verified on {{ $admin->email_verified_at->format('d M Y, h:i A') }}
                                            </p>
                                        @else
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">{{ $admin->last_login_ip ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $('#sendVerificationEmailBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('admin.settings.email.send-verification') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#deleteAccountBtn').on('click', function() {
            ...
            $('#confirmDeleteBtn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.settings.delete-account') }}",
                    method: "POST",
                    dataType: "json",
                    data: formData,
                    processData: false,
