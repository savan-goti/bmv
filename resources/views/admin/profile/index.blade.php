                        ...
                        <form method="POST" id="profileSettingForm">
                            ...
                            <div class="text-center">
                                <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                    <img src="{{ $admin->profile_image }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" maxlength="15" name="phone" value="{{ $admin->phone }}">
                                </div>
            ...
            submitHandler: function (form, e) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#headerProfileName').html(result.data.name);
                    ...
                    error: function (xhr) {
                        ...
                        if (data.hasOwnProperty('error')) {
                            if (data.error.hasOwnProperty('name')) {
                                $("#name-error").html(data.error.name).show();
                            }
