                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            @if($staff->two_factor_enabled && $staff->two_factor_confirmed_at)
                                <!-- 2FA is enabled -->
                                <div class="alert alert-success">
                                    <i class="ri-shield-check-line"></i> 
                                    Two-factor authentication is <strong>enabled</strong> and protecting your account.
                                    <br>
                                    <small class="text-muted">Enabled on {{ $staff->two_factor_confirmed_at->format('d M Y, h:i A') }}</small>
                                </div>
                ...
                <div class="card mt-4 border-danger">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="text-muted mb-3">
                            <li>Permanently delete your staff account</li>
...
<script>
    $(document).ready(function() {
        ...
        $('#sendVerificationEmailBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('staff.settings.email.send-verification') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        function loadSessions() {
            $.ajax({
                url: "{{ route('staff.settings.sessions') }}",
                method: "GET",
                dataType: "json",
                success: function (result) {
        ...
        $(document).on('click', '.logout-session-btn', function() {
            ...
            $.ajax({
                url: "{{ route('staff.settings.sessions.logout') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#logoutAllOthersBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('staff.settings.sessions.logout-others') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#enableTwoFactorBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('staff.settings.two-factor.enable') }}",
                method: "POST",
                dataType: "json",
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $('#verifyTwoFactorForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('staff.settings.two-factor.confirm') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#disableTwoFactorBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('staff.settings.two-factor.disable') }}",
                method: "POST",
                dataType: "json",
                data: formData,
                processData: false,
        ...
        $('#regenerateRecoveryCodesBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('staff.settings.two-factor.recovery-codes') }}",
                method: "POST",
                dataType: "json",
                data: {
                    _token: '{{ csrf_token() }}'
        ...
        $('#deleteAccountBtn').on('click', function() {
            // Create a custom modal for account deletion
            const modalHtml = `
            ...
            $('#confirmDeleteBtn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('staff.settings.delete-account') }}",
                    method: "POST",
                    dataType: "json",
                    data: formData,
                    processData: false,
