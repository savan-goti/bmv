            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('staff.sellers.index') }}">Sellers</a></li>
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="mt-4">
                                <div class="d-grid gap-2">
                                    @if (!$seller->is_approved)
                                        <form action="{{ route('staff.sellers.approve', $seller->id) }}" method="POST" class="d-block">
                                            @csrf
                                    ...
                                    @endif
                                    <a href="{{ route('staff.sellers.edit', $seller->id) }}" class="btn btn-primary w-100 mb-2">
                                        <i class="bx bx-edit"></i> Edit Seller
                                    </a>
                                    <a href="{{ route('staff.sellers.index') }}" class="btn btn-secondary w-100">
