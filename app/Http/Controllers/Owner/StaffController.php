...
class StaffController extends Controller
{
    ...
    {
        return view('owner.staffs.index');
    }
    ...
    public function ajaxData()
    {
        ...
        return DataTables::eloquent($result)
            ...
            ->addColumn('action', function($row){
                $viewUrl = route('owner.staffs.show', $row->id);
                $editUrl = route('owner.staffs.edit', $row->id);
                $deleteUrl = route('owner.staffs.destroy', $row->id);
    ...
    public function show(Staff $staff)
    {
        ...
        return view('owner.staffs.show', compact('staff'));
    }
