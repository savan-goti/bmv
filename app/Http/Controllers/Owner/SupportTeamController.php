...
class SupportTeamController extends Controller
{
    ...
    {
        return view('owner.support-team.index');
    }
    ...
    public function ajaxData()
    {
        ...
        return DataTables::eloquent($result)
            ...
            ->addColumn('action', function($row){
                $viewUrl = route('owner.support-team.show', $row->id);
                $editUrl = route('owner.support-team.edit', $row->id);
                $deleteUrl = route('owner.support-team.destroy', $row->id);
    ...
    public function create()
    {
        ...
        return view('owner.support-team.create', compact('roles', 'departments', 'queues'));
    }
    ...
    public function show(SupportTeamMember $supportTeamMember)
    {
        ...
        return view('owner.support-team.show', compact('supportTeamMember', 'departments', 'queues'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $validatedData['created_by_id'] = Auth::guard('owner')->user()->id;
            $validatedData['created_by_type'] = 'App\Models\Owner';
    ...
    public function edit(SupportTeamMember $supportTeamMember)
    {
        ...
        return view('owner.support-team.edit', compact('supportTeamMember', 'roles', 'departments', 'queues'));
    }
